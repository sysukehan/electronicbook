...
public class ZoomTestActivityOne extends Activity implements OnTouchListener {
	...
	private Runnable OutofTime = new Runnable() {
		...
		@Override
		public void run() {
			info.setendtime(9, info.getSystemTime());
			info.setjudgement(9, false);
			Bundle data = new Bundle();
			data.putSerializable("information", info);
			Intent sendintent = new Intent(context, ZoomTestActivityTwo.class);
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.zoomtestone_layout);
		...
		info.setbegintime(9, info.getSystemTime());
		
		AssetManager mgr=getAssets();//得到AssetManager
		Typeface tf = Typeface.createFromAsset(mgr, "fonts/SIMYOU.TTF");//根据路径得到Typeface
		title = (TextView) findViewById(R.id.title);
		question = (TextView) findViewById(R.id.test_question_ten);
		question.setText("请\n你\n把\n小\n狗\n变\n大\n再\n变\n小");
		title.setTypeface(tf);
		question.setTypeface(tf);
		yes = (TextView) findViewById(R.id.zoomtestoneyes);
		//no = (TextView) findViewById(R.id.zoomtestoneno);
		yes.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View view) {
				...
				Bundle data = new Bundle();
				data.putSerializable("information", info);
				sendintent = new Intent(context, ZoomTestActivityTwo.class);
				sendintent.putExtras(data);
						
				info.setendtime(9, info.getSystemTime());
				info.setjudgement(9, true);
		...
		no.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View view) {
				AlertDialog.Builder builder = new AlertDialog.Builder(ZoomTestActivityOne.this);
				...
				builder.setPositiveButton("下一个", new DialogInterface.OnClickListener() {
					...
					public void onClick(DialogInterface dialog, int which) {
						Bundle data = new Bundle();
						data.putSerializable("information", info);
						Intent sendintent = new Intent(ZoomTestActivityOne.this, ZoomTestActivityTwo.class);
						sendintent.putExtras(data);
		...
		*/
		sign = true;
		framelayout = (FrameLayout) findViewById(R.id.zoomarea1);
		imageview = (ImageView) findViewById(R.id.zoomimage_1);
