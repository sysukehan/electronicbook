...
public class ZoomTestActivityTwo extends Activity implements OnTouchListener {
	...
	private Runnable OutofTime = new Runnable() {
		...
		@Override
		public void run() {
			info.setendtime(10, info.getSystemTime());
			info.setjudgement(10, false);
			Bundle data = new Bundle();
			data.putSerializable("information", info);
			Intent sendintent = new Intent(context, ZoomTestActivityThree.class);
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.zoomtesttwo_layout);
		...
		info.setbegintime(10, info.getSystemTime());
		
		AssetManager mgr=getAssets();//得到AssetManager
		Typeface tf = Typeface.createFromAsset(mgr, "fonts/SIMYOU.TTF");//根据路径得到Typeface
		title = (TextView) findViewById(R.id.title);
		question = (TextView) findViewById(R.id.test_question_eleven);
		question.setText("请\n你\n把\n手\n套\n变\n大\n再\n变\n小");
		title.setTypeface(tf);
		question.setTypeface(tf);
		yes = (TextView) findViewById(R.id.zoomtesttwoyes);
		//no = (TextView) findViewById(R.id.zoomtesttwono);
		yes.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View view) {
				...
				Bundle data = new Bundle();
				data.putSerializable("information", info);
				sendintent = new Intent(context, ZoomTestActivityThree.class);
				sendintent.putExtras(data);
						
				info.setendtime(10, info.getSystemTime());
				info.setjudgement(10, true);
		...
		no.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View view) {
				AlertDialog.Builder builder = new AlertDialog.Builder(ZoomTestActivityTwo.this);
				...
				builder.setPositiveButton("下一个", new DialogInterface.OnClickListener() {
					...
					public void onClick(DialogInterface dialog, int which) {
						Bundle data = new Bundle();
						data.putSerializable("information", info);
						Intent sendintent = new Intent(ZoomTestActivityTwo.this, ZoomTestActivityThree.class);
						sendintent.putExtras(data);
		...
		*/
		sign = true;
		framelayout = (FrameLayout) findViewById(R.id.zoomarea2);
		imageview = (ImageView) findViewById(R.id.zoomimage_2);
