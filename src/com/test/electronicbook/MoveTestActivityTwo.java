...
public class MoveTestActivityTwo extends Activity implements OnTouchListener {
	...
	private Runnable OutofTime = new Runnable() {
		...
		@Override
		public void run() {
			info.setendtime(7, info.getSystemTime());
			info.setjudgement(7, false);
			Bundle data = new Bundle();
			data.putSerializable("information", info);
			Intent sendintent = new Intent(context, MoveTestActivityThree.class);
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.movetesttwo_layout);
		...
		info.setbegintime(7, info.getSystemTime());
		oothandler = new Handler();
		oothandler.postDelayed(OutofTime, 45000);
		
		framelayout = (FrameLayout) findViewById(R.id.movelayout_2);
		imageview = (ImageView) findViewById(R.id.moveimage_2);
		imageview.setOnTouchListener(this);
		
		AssetManager mgr=getAssets();//得到AssetManager
		Typeface tf= Typeface.createFromAsset(mgr, "fonts/SIMYOU.TTF");//根据路径得到Typeface
		title = (TextView) findViewById(R.id.title);
		question = (TextView) findViewById(R.id.test_question_eight);
		title.setTypeface(tf);
		question.setTypeface(tf);
		
		yes = (TextView) findViewById(R.id.movetesttwoyes);
		//no = (TextView) findViewById(R.id.movetesttwono);
		yes.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View view) {
				...
				Bundle data = new Bundle();
				data.putSerializable("information", info);
				sendintent = new Intent(context, MoveTestActivityThree.class);
				sendintent.putExtras(data);
						
				info.setendtime(7, info.getSystemTime());
				info.setjudgement(7, true);
		...
		no.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View view) {
				AlertDialog.Builder builder = new AlertDialog.Builder(MoveTestActivityTwo.this);
				...
				builder.setPositiveButton("下一个", new DialogInterface.OnClickListener() {
					...
					public void onClick(DialogInterface dialog, int which) {
						Bundle data = new Bundle();
						data.putSerializable("information", info);
						Intent sendintent = new Intent(MoveTestActivityTwo.this, MoveTestActivityThree.class);
						sendintent.putExtras(data);
